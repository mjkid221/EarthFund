...
interface IGovernor {
  ...
  function getPredictedAddresses(Token calldata _tokenData,
    Safe calldata _safeData) external view returns (address token, address safe, address realityModule);
